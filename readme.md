...
本次專案以顯示卡銷售資料為基礎，分析其價格、效能（分數）、以及性價比（CP 值）等指標，探索市場趨勢與產品定位。分析目標包括：
...
4. 即便顯卡平均價格持續上升，但 CP 值也跟著持續上升
5. 唯一 CP 值快速下降的時間點為 2021 年顯示卡礦災的時期
6. 可優先購買 AMD RX9070XT/RX9070、Intel ARC B570/ARC B580 顯示卡。具目前最高的 CP 值
